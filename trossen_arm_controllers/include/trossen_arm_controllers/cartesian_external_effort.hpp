...
#ifndef TROSSEN_ARM_CONTROLLERS__CARTESIAN_EXTERNAL_EFFORT_HPP_
#define TROSSEN_ARM_CONTROLLERS__CARTESIAN_EXTERNAL_EFFORT_HPP_
...
class CartesianExternalEffortController : public controller_interface::ControllerInterface
{
public:
...
private:
  struct Command
  {
    std::array<double, 6> wrench{};  // fx, fy, fz, tx, ty, tz; N and Nm.
...
#endif  // TROSSEN_ARM_CONTROLLERS__CARTESIAN_EXTERNAL_EFFORT_HPP_
