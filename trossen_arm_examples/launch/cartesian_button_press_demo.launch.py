    ...
    demo_node = Node(
        ...
        parameters=[
            ...
            ),
            {
                ...
                'effort_command_frame_id': LaunchConfiguration('effort_command_frame_id'),
                'position_goal_time': LaunchConfiguration('position_goal_time'),
                'effort_goal_time': LaunchConfiguration('effort_goal_time'),
                'position_interpolation_space': LaunchConfiguration('position_interpolation_space'),
                'effort_interpolation_space': LaunchConfiguration('effort_interpolation_space'),
...
def generate_launch_description() -> LaunchDescription:
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument('position_command_frame_id', default_value='base_link'),
            DeclareLaunchArgument('effort_command_frame_id', default_value='base_link'),
            DeclareLaunchArgument('position_goal_time', default_value='2.0'),
            DeclareLaunchArgument('effort_goal_time', default_value='0.0'),
            DeclareLaunchArgument('position_interpolation_space', default_value='cartesian', choices=['joint', 'cartesian']),
            DeclareLaunchArgument('effort_interpolation_space', default_value='cartesian', choices=['joint', 'cartesian']),
